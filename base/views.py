...
def registerPage(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            user.save(*args, **kawrgs)
            login(request, user)
            return redirect('HOME')
        else:
            messages.error(request, 'An error occured while creating user')    
...
def updateUser(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, 'An error occured while updating user')
